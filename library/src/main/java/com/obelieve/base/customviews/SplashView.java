...
public class SplashView extends FrameLayout {
    ...
    public void loadData(@DrawableRes final int[] resInts, @DrawableRes int selectedRes, @DrawableRes int unSelectedRes, @ColorInt int nextColor) {
        final ImageView[] views = new ImageView[resInts.length];
